...
function showJoke(){
  ...
  newElement.innerText=randomJoke;
  const isJoke=container.querySelector('p');
  clearAll();
  container.appendChild(newElement);
}
function showQuote(){
  const randomQuoteUrl=getRandomData('quotes');
  const container=document.querySelector('.quote-content');
  const newElement=document.createElement('p');
  newElement.innerText=randomQuoteUrl.quote+'\nwritten by '+randomQuoteUrl.author;
  clearAll();
  container.appendChild(newElement);
}
function showRiddle(){
  const randomRiddleUrl=getRandomData('riddles');
  const container=document.querySelector('.riddle-content');
  const newriddle=document.createElement('p');
  newriddle.innerText=randomRiddleUrl.question;
  const ans=document.createElement('p');
  ans.innerText=randomRiddleUrl.answer;
